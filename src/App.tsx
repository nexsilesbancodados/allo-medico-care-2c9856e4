...
const SouMedico = lazy(() => import("./pages/SouMedico"));
const SouClinica = lazy(() => import("./pages/SouClinica"));
      ...
      <BrowserRouter>
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route path="/sou-medico" element={<SouMedico />} />
            <Route path="/sou-clinica" element={<SouClinica />} />
