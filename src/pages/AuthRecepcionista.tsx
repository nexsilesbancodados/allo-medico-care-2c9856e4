...
import { Mail, Lock, ArrowLeft, ClipboardList, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="lg:hidden bg-gradient-to-br from-primary/70 to-secondary/70 px-6 pt-[max(env(safe-area-inset-top,12px),12px)] pb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-primary-foreground">Portal da Recepção</h1>
              <p className="text-xs text-primary-foreground/70">Gestão de atendimento</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-4 pb-[max(env(safe-area-inset-bottom,8px),8px)] border-t border-border bg-muted/30 flex items-center justify-center gap-5 text-xs text-muted-foreground">
          <span className="flex items-center gap-1.5"><ClipboardList className="w-3.5 h-3.5 text-primary shrink-0" /> Recepção</span>
