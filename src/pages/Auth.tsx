            ...
            {success ? (
              ...
              <motion.div key="login" {...pageVariants} transition={{ duration: 0.3 }}>
                ...
                <form onSubmit={handleLogin} className="space-y-4" noValidate>
                  ...
                  <Button type="button" variant="outline" className="w-full gap-2 text-sm h-11 rounded-xl" onClick={() => supabase.auth.signInWithOAuth({ provider: "google", options: { redirectTo: window.location.origin + "/dashboard" } })}>
