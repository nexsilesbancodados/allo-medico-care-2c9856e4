              ...
              <motion.div key="login" {...pageVariants} transition={{ duration: 0.3 }}>
                ...
                <form onSubmit={handleLogin} className="space-y-4" noValidate>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <Button type="button" variant="outline" className="gap-2 text-xs h-10 rounded-xl" onClick={() => supabase.auth.signInWithOAuth({ provider: "google", options: { redirectTo: window.location.origin + "/dashboard" } })}>
                    ...
                    <Button type="button" variant="outline" className="gap-2 text-xs h-10 rounded-xl" onClick={() => supabase.auth.signInWithOAuth({ provider: "apple", options: { redirectTo: window.location.origin + "/dashboard" } })}>
