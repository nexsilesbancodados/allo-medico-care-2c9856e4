      ...
      <div className="max-w-2xl mx-auto pb-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <><img src="/src/assets/mascot-wave.png" alt="Pingo" className="w-20 h-20 object-contain mx-auto drop-shadow-md mb-3 select-none" /><p className="text-[13px] font-semibold text-foreground">Nenhum médico encontrado</p></>
