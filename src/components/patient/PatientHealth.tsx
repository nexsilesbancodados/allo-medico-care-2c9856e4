        ...
        <Tabs defaultValue="consultations">
          ...
          <TabsContent value="consultations" className="mt-4 space-y-3">
            {loading ? (
              ...
              <div className="text-center py-8 rounded-2xl border border-dashed border-border/40 bg-muted/10"><img src={mascotWave} alt="Pingo" className="w-16 h-16 object-contain mx-auto drop-shadow-md mb-2 select-none" /><p className="text-[12px] font-semibold text-foreground">Nenhuma consulta realizada</p></div>
          ...
          <TabsContent value="prescriptions" className="mt-4 space-y-3">
            {prescriptions.length === 0 ? (
              <div className="text-center py-8 rounded-2xl border border-dashed border-border/40 bg-muted/10"><img src={mascotThumbsup} alt="Pingo" className="w-16 h-16 object-contain mx-auto drop-shadow-md mb-2 select-none" /><p className="text-[12px] font-semibold text-foreground">Nenhuma receita emitida</p></div>
            ) : prescriptions.map(p => (
          ...
          <TabsContent value="documents" className="mt-4 space-y-3">
            {documents.length === 0 ? (
              <div className="text-center py-8 rounded-2xl border border-dashed border-border/40 bg-muted/10"><img src={mascotReading} alt="Pingo" className="w-16 h-16 object-contain mx-auto drop-shadow-md mb-2 select-none" /><p className="text-[12px] font-semibold text-foreground">Nenhum exame enviado</p></div>
            ) : documents.map(d => (
