...
import { Loader2, FileText, Download, ShieldCheck, Share2 } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-12 space-y-2 pb-24 md:pb-8">
              <FileText className="w-12 h-12 text-muted-foreground/30 mx-auto" />
              <div className="text-center py-8 rounded-2xl border border-dashed border-border/40 bg-muted/10 mt-4"><img src={mascotReading} alt="Pingo" className="w-20 h-20 object-contain mx-auto drop-shadow-md mb-2 select-none" loading="lazy" decoding="async" width={80} height={80} /><p className="text-[13px] font-semibold text-foreground mb-1">Nenhum exame solicitado ainda</p><p className="text-[11px] text-muted-foreground">Seus exames solicitados aparecerão aqui</p></div>
