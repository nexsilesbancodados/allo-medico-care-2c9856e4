        ...
        {tickets.length === 0 ? (
          <Card className="border-border">
            <CardContent className="py-12 text-center">
              ...
              <><img src={pingoSupport} alt="Pingo" className="w-20 h-20 object-contain mx-auto drop-shadow-md mb-2 select-none" loading="lazy" decoding="async" width={80} height={80} /><p className="text-[13px] font-semibold text-foreground">Nenhum atendimento aberto</p></>
