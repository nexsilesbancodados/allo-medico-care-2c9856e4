import { Calendar, FileText, Users, DollarSign, Settings, User, FileBadge, Clock, History, CalendarDays, Upload, MessageCircle, SlidersHorizontal, ClipboardList, Zap, RefreshCw } from "lucide-react";
...
export const getDoctorNav = (active: string) => [
  ...
  { label: "Laudos", href: "/dashboard/doctor/report-queue?role=doctor", icon: <ClipboardList className="w-4 h-4" />, active: active === "report-queue" || active === "exam-request" || active === "report-templates", group: "Documentos" },
