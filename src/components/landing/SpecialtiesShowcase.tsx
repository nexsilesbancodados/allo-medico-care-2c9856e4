...
const specialties = [
  ...
  { name: "Oncologia", icon: FlaskRound, image: specOncologia, color: "from-orange-600/20 to-orange-600/5" },
  { name: "Otorrinolaringologia", icon: Ear, image: specOtorrino, color: "from-purple-500/20 to-purple-500/5" },
  { name: "Pneumologia", icon: Lungs, image: specPneumologia, color: "from-sky-600/20 to-sky-600/5" },
