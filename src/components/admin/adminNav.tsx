...
export const getAdminNav = (active: string) => [
  { label: "Visão Geral", href: "/dashboard/admin/panel-center", icon: <BarChart3 className="w-4 h-4" />, active: active === "overview" || active === "panel-center", group: "Principal" },
  { label: "Centro de Painéis", href: "/dashboard/admin/panel-center", icon: <LayoutGrid className="w-4 h-4" />, active: active === "panel-center", group: "Principal" },
