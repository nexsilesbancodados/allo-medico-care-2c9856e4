...
// Formas orgânicas irregulares tipo aquarela (blob)
const BLOB_SHAPES = [
...
// Paleta de cores vibrantes aquarela — igual à referência
const COLOR_MAP: Record<
  BlobColor,
  {
    from: string;   // cor principal
    mid: string;    // cor intermediária
    to: string;     // cor mais escura (bottom)
...
const BlobKPICard = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Brilho superior esquerdo — efeito aquarela */}
        <div
          ...
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(ellipse, rgba(255,255,255,0.60) 0%, rgba(255,255,255,0.15) 55%, transparent 100%)",
            filter: "blur(5px)",
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-1.5 px-3 text-center w-full">
          ...
          <span
            style={{
              ...
              fontWeight: 600,
              fontSize: "clamp(0.54rem, 1.6vw, 0.68rem)",
              lineHeight: 1.3,
